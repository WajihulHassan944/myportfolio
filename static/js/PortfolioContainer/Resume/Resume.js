...
const Resume = (props) => {
    ...
    const resumeDetails = [ <
        ...
        subHeading = {
            "Command Secondary School Mbiri"
        }
        fromDate = {
            "2007"
        }
        ...
        key = "projects" > {
            projectsDetails.map((projectsDetails, index) => ( <
                ...
                subHeading = {
                    projectsDetails.subHeading
                }
                description = {
                    projectsDetails.description
                }
                fromDate = {
                    projectsDetails.duration.fromDate
                }
                toDate = {
                    projectsDetails.duration.toDate
                }
                />
            ))
        } <
    ...
    const getBullets = () => {
        return resumeBullets.map((bullet, index) => ( <
            ...
            src = {
                require(`../../assets/Resume/${bullet.logoSrc}`).default
            }
            alt = "B" /
            >
            <
